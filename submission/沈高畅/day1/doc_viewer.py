    ...
    def get_filtered_records(self, table_name: str = "default", field_name: str = "", field_value: str = "") -> List[Dict[str, Any]]:
        ...
        if field_name and field_value:
            ...
            for record in all_records:
                ...
                # 支持字符串包含匹配
                if isinstance(field_val, list) and field_value in str(field_val):
...
if __name__ == "__main__":
    # 从环境变量获取配置信息
    app_id = "cli_a8e1d12a187d101c"
    app_secret = "t7o1ehAlhzbHB1x5jfW5Se0SHSn7jfUo"
